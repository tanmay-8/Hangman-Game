...
list1 = list(word)
dashes = ["_ " for i in list1]

while now<7 and "".join(dashes)!=word:
    ...
    if(ch in list1 ):
        ...
        list1.pop(i)
        list1.insert(i,"")
        print(f"{ch} is  in word")
        print(f"You have {7-now} lives")

    elif(ch not in list1 and ch in dashes):
        print("\nYou already guessed it.\n")

    else:
        now += 1
        print(f"{ch} is not in word")
        if(now!=7):
            print("😨 You are loosing it...")
            print(f"You have {7-now} lives")
        print(hangman[now])
...
if(now==7):
    ...
    print("😔 Your Man Has Been Hanged ")
else:
